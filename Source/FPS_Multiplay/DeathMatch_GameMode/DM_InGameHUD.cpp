...
#include "FPS_Multiplay/FPS_Default/Widgets/FPS_MultiplayGameTimeWidget.h"
#include "FPS_Multiplay/FPS_Default/Widgets/FPS_MultiplayInGameMenuWidget.h"
...
void ADM_InGameHUD::UpdateLeaderBoard(int Kills, int Deaths)
{
	if (IsValid(LeaderBoardWidget))
	{
	...
	{
		UE_LOG(LogTemp, Error, TEXT("ADM_InGameHUD::UpdateLeaderBoard(int Kills, int Deaths) -> StatsWidget is not Valid!!!"));
	}
}
...
void ADM_InGameHUD::ResetLeaderBoard()
{
	if (IsValid(LeaderBoardWidget))
	{
	...
	{
		UE_LOG(LogTemp, Warning, TEXT("ADM_InGameHUD::ResetLeaderBoard() -> LeaderBoardWidget is not Valid!!!"));
	}
}
...
void ADM_InGameHUD::ToggleLeaderBoardVisibility()
{
	...
	{
		UE_LOG(LogTemp, Warning, TEXT("ADM_InGameHUD::ToggleLeaderBoardVisibility() -> LeaderBoardWidget is not Valid!!!"));
	}
}
