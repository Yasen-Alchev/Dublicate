...
#include "PlayFab.h"
#include "FPS_Multiplay/FPS_MainMenu/MainMenuWidget.h"
#include "Core/PlayFabError.h"
#include "Core/PlayFabClientDataModels.h"
#include "FPS_MultiplayGameInstance.generated.h"

/**
 * 
 */
UCLASS()
class FPS_MULTIPLAY_API UFPS_MultiplayGameInstance : public UGameInstance
{
	GENERATED_BODY()

public:

	UFPS_MultiplayGameInstance(const FObjectInitializer& ObjectInitializer);
